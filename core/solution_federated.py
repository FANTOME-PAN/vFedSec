...
from core.fl_logic import TrainClientTemplate
from core.fl_utils import pyobj2bytes, bytes2pyobj
...
class TrainActiveParty(TrainClientTemplate):
    ...
    def __init__(
        ...
        if not self.initialised:
            ...
            self.pp_lm: nn.Module = generate_passive_party_local_module()
